(defproject reader-links "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "reader-links.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main reader-links.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "reader-links.core/on-figwheel-reload"}

                :compiler {:main reader-links.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/reader_links.js"
